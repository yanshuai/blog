...
安装firefox及selenium-ide插件后，点击selenium-ide按钮，选择Options->Options->Formats，然后点击Add按钮，设置Name of the format为jspringbot，设置source content（设置完成后需要重启firefox）为jspringbt-selenium-formats.js的文件内容，其中jspringbot-selenium-formats.js文件可从[https://github.com/yanshuai/jspringbot-selenium-formats/blob/master/jspringbot-selenium-formats.js](https://github.com/yanshuai/jspringbot-selenium-formats/blob/master/jspringbot-selenium-formats.js)获取得到。
